...
class AttU_Net4(nn.Module):
    def __init__(self,img_ch=3,output_ch=1):
        ...
        self.Conv1 = bottleneck(ch_in=img_ch,ch_out=64)
        self.Conv2 = bottleneck(ch_in=64,ch_out=128)
        self.Conv3 = bottleneck(ch_in=128,ch_out=256)
        self.Conv4 = bottleneck(ch_in=256,ch_out=512)
        self.Conv5 = bottleneck(ch_in=512,ch_out=1024)
