...
if __name__ == '__main__':
    input_folder = 'U-Mamba/data/nnUNet_results/Dataset112_ArcadeXCA/nnUNetTrainerattUMambaBot_2__nnUNetPlans__2d/inference/'
    out_preds = 'stenExp/model_runs/nnU-attUMambaBot_2_2_2/one/preds/'

    labels_folder = 'U-Mamba/data/nnUNet_raw/Dataset112_ArcadeXCA/labels_test/'
    masks = 'stenExp/model_runs/nnU-attUMambaBot_2_2_2/one/labels_test/'

    input_images_folder = 'U-Mamba/data/nnUNet_raw/Dataset112_ArcadeXCA/images_test/'
    images = 'stenExp/model_runs/nnU-attUMambaBot_2_2_2/one/images_test/'

    nifti2png(input_folder, out_preds)
    nifti2png(labels_folder, masks)
    nifti2png(input_images_folder, images)

    save_path = 'stenExp/model_runs/nnU-attUMambaBot_2_2_2/one/results/'
    results_path = 'stenExp/model_runs/nnU-attUMambaBot_2_2_2/one/results/results.txt'
    size=(256,256)
